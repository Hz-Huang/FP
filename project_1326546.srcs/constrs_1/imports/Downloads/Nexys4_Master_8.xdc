...
#set_property PACKAGE_PIN T5 [get_ports {[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {Output[4]}]
##Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
#set_property PACKAGE_PIN T4 [get_ports {Output[5]}]					
...
#set_property PACKAGE_PIN U6 [get_ports {Output[7]}]					
...
#set_property PACKAGE_PIN U1 [get_ports {zero}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {zero}]
#Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
#set_property PACKAGE_PIN R2 [get_ports {carry}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {carry}]
#Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
#set_property PACKAGE_PIN P2 [get_ports {over}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {over}]


#Bank = 34, Pin name = IO_L5P_T0_34,						Sch name = LED16_R
set_property PACKAGE_PIN K5 [get_ports undone]					
	set_property IOSTANDARD LVCMOS33 [get_ports undone]
#Bank = 15, Pin name = IO_L5P_T0_AD9P_15,					Sch name = LED16_G
set_property PACKAGE_PIN F13 [get_ports done]				
